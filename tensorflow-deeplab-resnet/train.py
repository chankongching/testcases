...
BATCH_SIZE = 2
DATA_DIRECTORY = './input/input/VOCdevkit/VOC2012'
DATA_LIST_PATH = './input/input/dataset/train.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '321,321'
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = './input/input/deeplab_resnet.ckpt'
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 1000
SNAPSHOT_DIR = './result/snapshots/'
WEIGHT_DECAY = 0.0005
